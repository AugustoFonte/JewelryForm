...
export default function QuestionOne({
  ...
  const handleOptionClick = (option) => {
    updateFormData("jewelryType", option);
    if (option === "Outro, identificar qual.") {
